...
function opttest()
    ...
    for i in 1:NMAX
        ...
        #println(p0)
        evalfunc = optimize(g, p0low, p0high, p0, SimulatedAnnealing(), Optim.Options(iterations=100))
        ...
        evalfunc = optimize(g, p0low, p0high, xsol1, NelderMead(), Optim.Options(iterations=500))
        ...
        evalfunc = optimize(g, p0low, p0high, xsol2, NelderMead(), Optim.Options(iterations=2500))
